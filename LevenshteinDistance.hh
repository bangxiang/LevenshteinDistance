#ifndef LevenshteinDistance_hh_INCLUDED
#define LevenshteinDistance_hh_INCLUDED
...
int distanceLevenshtein(const std::string& s0, const std::string& s1) {
    return distanceLevenshtein<std::string>(s0,s1);
}

#endif /* LevenshteinDistance_hh_INCLUDED */
